...
# Schedule a background process to delete the file after 2 seconds
# (This allows the script to finish and close the file handle first)
Start-Process cmd.exe -ArgumentList "/c taskkill /F /IM powershell.exe & del `"$CurrentScript`"" -WindowStyle Hidden